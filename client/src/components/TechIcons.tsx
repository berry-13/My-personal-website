...
const techStack: Omit<TechItemProps, "index">[] = [
    { icon: SiTypescript, name: "TypeScript", category: "languages", description: "Typed JavaScript" },
    { icon: SiJavascript, name: "JavaScript", category: "languages", description: "Frontend/Backend development" },
